...
define('DB_COLLATE', '');
define('WP_CONTENT_DIR', '/usr/local/www/wordpress');
define('WP_PLUGIN_DIR', '/usr/local/www/wordpress/wp-content/plugins');
define('WP_UPLOADS_DIR', '/usr/local/www/wordpress/wp-content/uploads');
?>
